...
namespace Ecommerce_loja_de_Games.Data
{
    public class AppDbContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<Produto>().ToTable("tb_produtos"); // metodo resposavel para criar as tabelas dentro do banco

            modelBuilder.Entity<Categoria>().ToTable("tb_Categoria"); // tabela temas
